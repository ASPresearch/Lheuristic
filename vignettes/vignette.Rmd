---
title: "L-shaped gene selection from expression and methylation data"
author: "Berta Miro Cau and Alex Sánchez-Pla"
date: "`r Sys.Date()`"
output:
  rmarkdown::html_vignette: default
vignette: > 
  %\VignetteIndexEntry{L-shaped gene selection from expression and methylation data}
...
```{r}
correlation <- correlationSelection(mae1, type = "Spearman",
    pValCutoff = 0.25, rCutoff = -0.5, adj = TRUE)

correlationL <- correlation[!is.na(correlation$SigNegCorr) & correlation$SigNegCorr, ]
correlationNoL <- correlation[!is.na(correlation$SigNegCorr) & !correlation$SigNegCorr, ]

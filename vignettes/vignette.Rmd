...
vignette: > 
  %\VignetteIndexEntry{Selecting L-shaped genes from expression 
    and methylation datasets}
...
message(
    "The number of genes selected with the 
    correlation method is: ", sum(correlationL$SigNegCorr),
    "\n"
)
```
...
plotGeneSel(xMet = xVec, yExp = yVec,
    titleText = titleT,
    x1 = 1/3, x2 = 2/3)

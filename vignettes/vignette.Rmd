...
**Labeling the experiments as *methylation* and *expression* in that particular order and name is essential for the proper functioning and use of the package functions.**

```{r}

library(MultiAssayExperiment)
doubleExp <- list("methylation" = TCGAmet,
                  "expression"  = TCGAexp)

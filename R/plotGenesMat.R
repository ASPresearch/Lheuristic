...
#'
plotGenesMat <- function(mets, expres, fileName = NULL, text4Title = NULL, x1 = 1 / 3,
    x2 = 2 / 3, y1 = NULL, y2 = NULL, percY1 = 1 / 3, percY2 = 2 / 3, plotGrid = TRUE,
    logicSc = NULL) {
    if (!is.null(fileName)) {
    ...
    for (gene in seq_len(nrow(expres))) {
        ...
        plotGeneSel(
            xMet = xVec, yExp = yVec, titleText = text4Title[gene], x1 = x1,
